...
type MarkdownRemarkFrontmatterFieldSelector = {
  ...
  readonly keyVisual: InputMaybe<FileFieldSelector>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly keyVisual: InputMaybe<FileFilterInput>;
...
type MarkdownRemarkFrontmatterSortInput = {
  ...
  readonly keyVisual: InputMaybe<FileSortInput>;
...
type PostPageQuery = { readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly updatedAt: string | null, readonly slug: string | null, readonly author: string | null, readonly category: ReadonlyArray<string | null> | null, readonly createdAt: string | null, readonly keyVisual: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type postsQueryVariables = Exact<{ [key: string]: never; }>;


type postsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly previous: { readonly id: string, readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null } | null, readonly node: { readonly id: string, readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null }, readonly next: { readonly id: string, readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null } | null }> } };

type paginationQueryVariables = Exact<{ [key: string]: never; }>;


type paginationQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null } | null }> } };
